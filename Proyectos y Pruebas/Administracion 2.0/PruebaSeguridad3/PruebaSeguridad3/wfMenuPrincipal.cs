...
namespace PruebaSeguridad3
{
    public partial class wfMenuPrincipal : Form
    {
        ...
        private void wfMenuPrincipal_FormClosed(object sender, FormClosedEventArgs e)
        {
            //Controles.vSalirSesion();
        }

        private void adminstraciónToolStripMenuItem_Click(object sender, EventArgs e)
        {
            wfAdminitrador Admin = new wfAdminitrador();
            Admin.Privilegio = new E_DatosPublicos().iCodigoPrivilegio;
            Admin.NuevaCategoria("Otros");
            Admin.NuevoBoton("Menu de algo", new PruebaSeguridad3.Form1(), 2, global::PruebaSeguridad3.Properties.Resources.Sincronizado);
            Admin.vCargarAdministrador();
        }
